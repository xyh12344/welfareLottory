 ...
 * 主页Fragment
 */
public class PlwFragment extends BaseFragment {
    ...
    protected void initView() {
        ...
        mBtnOne.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mList.add(Utilities.getPlwOne(mListRedAll));
                mTvTime.setText(Utilities.getDateTimeEs(new Date()));
                mAdapter.notifyDataSetChanged();
        ...
        mBtnFive.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mList.addAll(Utilities.getPlwFive(mListRedAll));
                mTvTime.setText(Utilities.getDateTimeEs(new Date()));
                mAdapter.notifyDataSetChanged();
            }
        });
        ...
        mBtnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cnt == 1)
                {
                    sbTotal.append("排列五，再随机4个：\n");
                }
                else
                    sbTotal.append("排列五\n");

                StringBuilder sb;
                for (PLWBall ball : mList)
                {
        ...
        mAdapter.setmCpType(CPType.PLW);

        //初始化数据
        if (mList == null)
            mList = new ArrayList();
        mAdapter.setListPlw(mList);
