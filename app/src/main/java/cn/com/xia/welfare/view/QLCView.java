...
public class QLCView extends BaseBallView {
    View rootView;
    ...
    public QLCView(@NonNull Context context) {
        super(context);
        rootView = LayoutInflater.from(context).inflate(R.layout.view_qws_one, this);
    ...
    public QLCView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        rootView = LayoutInflater.from(context).inflate(R.layout.view_qws_one, this);
        r7 = (RedBallView)rootView.findViewById(R.id.r7);
    ...
    public QLCView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
