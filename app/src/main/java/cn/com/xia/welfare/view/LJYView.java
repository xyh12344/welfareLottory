...
public class LJYView extends BaseBallView {
    View rootView;
    ...
    public LJYView(@NonNull Context context) {
        super(context);
    ...
    public LJYView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        rootView = LayoutInflater.from(context).inflate(R.layout.view_ssq_one, this);
        b1 = (BlueBallView)rootView.findViewById(R.id.b1);
    ...
    public LJYView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
