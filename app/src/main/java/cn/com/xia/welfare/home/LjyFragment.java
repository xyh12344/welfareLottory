 ...
 * 主页Fragment
 */
public class LjyFragment extends BaseFragment {
    ...
    protected void initView() {
        ...
        mBtnOne.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mList.add(Utilities.getLjyOne(mListRedAll,mListBlueAll));
                mTvTime.setText(Utilities.getDateTimeEs(new Date()));
                mAdapter.notifyDataSetChanged();
        ...
        mBtnFive.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mList.addAll(Utilities.getLjyFive(mListRedAll,mListBlueAll));
                mTvTime.setText(Utilities.getDateTimeEs(new Date()));
                mAdapter.notifyDataSetChanged();
            }
        });
        ...
        mBtnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cnt == 1)
                {
                    sbTotal.append("东方6加1，再随机4个：\n");
                }
                else
                    sbTotal.append("东方6加1\n");

                StringBuilder sb;
                for (LJYBall ball : mList)
                {
                    sb = new StringBuilder();

                    int cntRedball = ball.getmListRedBall().size();
                    for (int i =0;i < cntRedball - 1; i++)
                    {
                        BaseBall b = ball.getmListRedBall().get(i);
                        sb.append(b.getValue() + "  ");
                    }
                    sb.append(ball.getmListRedBall().get(cntRedball - 1).getValue() + " - ");

                    sb.append(ball.getB1().getValue());
                    sb.append("\n");
        ...
        mAdapter.setmCpType(CPType.LJY);

        //初始化数据
        if (mList == null)
            mList = new ArrayList();
        mAdapter.setListLjy(mList);
    ...
    public void initData() {
        ...
        {
            BaseBall ball = new BaseBall(i);
            ball.setChineseZodiacSigns(true);
