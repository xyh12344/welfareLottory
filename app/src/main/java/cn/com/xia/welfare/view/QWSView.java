...
public class QWSView extends BaseBallView {
    View rootView;
    ...
    public QWSView(@NonNull Context context) {
        super(context);
    ...
    public QWSView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        rootView = LayoutInflater.from(context).inflate(R.layout.view_qws_one, this);
        r7 = (RedBallView)rootView.findViewById(R.id.r7);
    ...
    public QWSView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
