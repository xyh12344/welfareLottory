 ...
 * 主页Fragment
 */
public class QlcFragment extends BaseFragment {
    ...
    protected void initView() {
        ...
        mBtnOne.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mList.add(Utilities.getQlcOne(mListRedAll));
                mTvTime.setText(Utilities.getDateTimeEs(new Date()));
                mAdapter.notifyDataSetChanged();
        ...
        mBtnFive.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mList.addAll(Utilities.getQlcFive(mListRedAll));
                mTvTime.setText(Utilities.getDateTimeEs(new Date()));
                mAdapter.notifyDataSetChanged();
            }
        });
        ...
        mBtnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cnt == 1)
                {
                    sbTotal.append("七乐彩，再随机4个：\n");
                }
                else
                    sbTotal.append("七乐彩\n");

                StringBuilder sb;
                for (QLCBall ball : mList)
                {
        ...
        mAdapter.setmCpType(CPType.QLC);

        //初始化数据
        if (mList == null)
            mList = new ArrayList();
        mAdapter.setListQlc(mList);
