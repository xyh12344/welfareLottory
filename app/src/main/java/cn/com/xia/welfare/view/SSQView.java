...
public class SSQView extends BaseBallView {
    View rootView;
    ...
    public SSQView(@NonNull Context context) {
        super(context);
    ...
    public SSQView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        rootView = LayoutInflater.from(context).inflate(R.layout.view_ssq_one, this);
        b1 = (BlueBallView)rootView.findViewById(R.id.b1);
    ...
    public SSQView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
