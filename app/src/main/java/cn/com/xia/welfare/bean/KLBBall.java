...
public class KLBBall {
    ...
    public BaseBall r8 = new BaseBall(false);

    public BaseBall b1 = new BaseBall();

    public void setNeedAddDis()
    {
        r1.setNeedAddDis(false);
        r2.setNeedAddDis(false);
        r3.setNeedAddDis(false);
        r4.setNeedAddDis(false);
        r5.setNeedAddDis(false);
        r6.setNeedAddDis(false);
    }
