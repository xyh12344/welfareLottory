 ...
 * 主页Fragment
 */
public class QxcFragment extends BaseFragment {
    ...
    protected void initView() {
        ...
        mBtnOne.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mList.add(Utilities.getQxcOne(mListRedAll,mListBlueAll));
                mTvTime.setText(Utilities.getDateTimeEs(new Date()));
                mAdapter.notifyDataSetChanged();
        ...
        mBtnFive.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mList.addAll(Utilities.getQxcFive(mListRedAll,mListBlueAll));
                mTvTime.setText(Utilities.getDateTimeEs(new Date()));
                mAdapter.notifyDataSetChanged();
            }
        });
        ...
        mBtnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cnt == 1)
                {
                    sbTotal.append("七星彩，再随机4个：\n");
                }
                else
                    sbTotal.append("七星彩\n");

                StringBuilder sb;
                for (QXCBall ball : mList)
                {
        ...
        mAdapter.setmCpType(CPType.QXC);

        //初始化数据
        if (mList == null)
            mList = new ArrayList();
        mAdapter.setListQxc(mList);
