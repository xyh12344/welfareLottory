 ...
 * 主页Fragment
 */
public class DltFragment extends BaseFragment {
    ...
    protected void initView() {
        ...
        mBtnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cnt == 1)
                {
                    sbTotal.append("大乐透，再随机4个：\n");
                }
                else
                    sbTotal.append("大乐透\n");

                StringBuilder sb;
                for (DLTBall ball : mList)
                {
                    ...
                    sb.append(ball.getmListBlueBall().get(0).getValue() + "  " + ball.getmListBlueBall().get(1).getValue());
        ...
        mAdapter.setmCpType(CPType.DLT);

        //初始化数据
        if (mList == null)
            mList = new ArrayList();

        mAdapter.setListDlt(mList);
