 ...
 * 主页Fragment
 */
public class KlbFragment extends BaseFragment {
    ...
    protected void initView() {
        ...
        mBtnOne.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mList.add(Utilities.getKlbOne(mListRedAll));
                mTvTime.setText(Utilities.getDateTimeEs(new Date()));
                mAdapter.notifyDataSetChanged();
        ...
        mBtnFive.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mList.addAll(Utilities.getKlbFive(mListRedAll));
                mTvTime.setText(Utilities.getDateTimeEs(new Date()));
                mAdapter.notifyDataSetChanged();
            }
        });
        ...
        mBtnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cnt == 1)
                {
                    sbTotal.append("快乐八选七复试16元：\n");
                }
                else
                    sbTotal.append("快乐八选八\n");

                StringBuilder sb;
                for (KLBBall ball : mList)
                {
        ...
        mAdapter.setmCpType(CPType.KLB);

        //初始化数据
        if (mList == null)
            mList = new ArrayList();
        mAdapter.setListKlb(mList);
